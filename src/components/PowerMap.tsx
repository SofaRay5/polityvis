...
export function PowerMap({ country, locale }: { country: Country; locale: Locale }) {
  ...
  return <section className="power-map" aria-labelledby={titleId}><div className="panel-heading"><div><p className="eyebrow">{t['navigation.power']}</p><h2 id={titleId}>{country.name}</h2></div></div>
